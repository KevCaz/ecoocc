...
test_cooccurrence_raw_core <- function(ab, ac, a, nsite) {
    .Call("_ecoocc_test_cooccurrence_raw_core", PACKAGE = "ecoocc", ab, ac, a, nsite)
}

test_cooccurrence_veech_core <- function(ab, ac, a, nsite) {
    .Call("_ecoocc_test_cooccurrence_veech_core", PACKAGE = "ecoocc", ab, ac, a, 
        nsite)
}
